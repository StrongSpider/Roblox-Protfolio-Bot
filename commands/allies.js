...
module.exports = {
    ...
    async execute(interaction) {
        ...
        try {
            ...
            if (alliedGroupsData.length == 0) return await interaction.editReply({ content: 'I could not find any allied groups connected to the main discord group that has a relationship with the selected user!' })
