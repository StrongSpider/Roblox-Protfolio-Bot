...
module.exports = {
    data: new SlashCommandBuilder()
        ...
        .addSubcommand(subcommand =>
            subcommand
                .setName('user')
                .setDescription('Gets group allied information from the provided discord user.')
        ...
        .addSubcommand(subcommand =>
            subcommand
                .setName('username')
                .setDescription('Gets group allied information from the provided roblox username.')
        ...
        .addSubcommand(subcommand =>
            subcommand
                .setName('userid')
                .setDescription('Gets group allied information from the provided roblox userid.')
    ...
    async execute(interaction) {
        ...
        function createPage(page) {
            var replyEmbed = new EmbedBuilder()
                .setFooter({ text: `Pages: ${page + 1}/${alliedGroupsData.length}` })
                .setThumbnail(thumbnailURL[0].imageUrl)
                .setTitle(userData.username + "'s Allied Connections 🔎")
                .setColor([0, 155, 255])
                .setTimestamp()
        ...
        if (alliedGroupsData.length > 0) {
            ...
            initalCollector.on('collect', async i => {
                if (i.customId === 'prev') {
                    ...
                    if (pageCount + 1 == alliedGroupsData.length) next.setDisabled(true);
        ...
        } else await interaction.reply({ content: 'I could not find any allied groups connected to the main discord group that has a relationship with the selected user!', ephemeral: true })
    },
};